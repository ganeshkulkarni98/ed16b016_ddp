...
if __name__ == "__main__":
    ...
    train_coco_dataset = '/lfs/usrhome/btech/ed16b016/scratch/project/fasterrcnn/train_1.json'

    val_image_folder = '/lfs/usrhome/btech/ed16b016/scratch/project/yolo/train_png_div_2'
    val_coco_dataset = '/lfs/usrhome/btech/ed16b016/scratch/project/fasterrcnn/test_1.json'

...
def model_init(model_name):
    ...
    if model_name == 'FasterRCNN':
      ...
      weight_file_path = '/lfs/usrhome/btech/ed16b016/scratch/fasterrcnn/fasterrcnn_resnet50_fpn_coco-258fb6c6.pth'
...
if __name__ == "__main__":
    ...
    train_image_folder = '/lfs/usrhome/btech/ed16b016/scratch/vinbig_yolo'
    train_coco_dataset = '/lfs/usrhome/btech/ed16b016/scratch/fasterrcnn/train_1.json'

    val_image_folder = '/lfs/usrhome/btech/ed16b016/scratch/vinbig_yolo'
    val_coco_dataset = '/lfs/usrhome/btech/ed16b016/scratch/fasterrcnn/test_1.json'

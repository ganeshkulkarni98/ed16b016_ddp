...
def get_vinbigdata_dicts(
    ...
    if not use_cache or not cache_path.exists():
        ...
        image_path = str(imgdir / "train_png_div_2" / f"{image_id}.png")
        ...
        for index, train_meta_row in tqdm(train_meta.iterrows(), total=len(train_meta)):
            ...
            filename = str(imgdir / "train_png_div_2" / f"{image_id}.png")
...
class Flags:
    # General
    debug: bool = True
    outdir: str = "/lfs/usrhome/btech/ed16b016/scratch/project/detectron2/results"

    # Data config
#     imgdir_name: str = "vinbigdata-chest-xray-resized-png-256x256"
    imgdir_name: str = "vinbigdata" # 512x512
    split_mode: str = "valid20"  # all_train or valid20
    seed: int = 111
...
flags_dict = {
    "debug": False,
    "outdir": "/lfs/usrhome/btech/ed16b016/scratch/project/detectron2/results/v10", 
...
# --- Read data ---
inputdir = Path("/lfs/usrhome/btech/ed16b016/scratch/project/yolo")

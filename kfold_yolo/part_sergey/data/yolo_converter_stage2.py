...
CUR_PATH = '/lfs/usrhome/btech/ed16b016/scratch/project/kfold_yolo/part_sergey/data/'
...
convertor_folder = '/lfs/usrhome/btech/ed16b016/scratch/project/yolo/converter_stage2'
...
for fold in range(5):
    ...
    for image_id in tqdm(original_boxes_df[image_id_column].unique()):
        ...
        for rad_id in rads:
            ...
            dest_lable_file = os.path.join(labels_folder, image_id + '.txt')
            sh.copy(source_label_file, dest_lable_file)

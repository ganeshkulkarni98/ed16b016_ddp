...
ROOT_PATH = "/lfs/usrhome/btech/ed16b016/scratch/project/kfold_yolo/part_zfturbo/output/"

#INPUT_PATH = ROOT_PATH + 'input/'
INPUT_PATH = "/lfs/usrhome/btech/ed16b016/scratch/"
...
def get_train_test_image_sizes():
    ...
    for index, row in sizes_train.iterrows():

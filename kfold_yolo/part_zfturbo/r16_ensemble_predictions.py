...
SUBM_PATH = '/lfs/usrhome/btech/ed16b016/scratch/project/kfold_yolo/part_zfturbo/output/subm_folder/'
OUTPUT_PATH = '/lfs/usrhome/btech/ed16b016/scratch/project/kfold_yolo/part_zfturbo/output/'

def get_test_image_sizes():
    sizes = dict()
    sizes_test = pd.read_csv(OUTPUT_PATH + 'test_shape.csv')
    ...
    for index, row in sizes_test.iterrows():
